...
pathtot = np.add(0.154494*pathE,np.add(0.016289*pathD,np.add(0.001969*pathC,np.add(0.367810*pathB,0.201004*pathA))))
np.savetxt("tot.csv", np.square(np.abs(pathR)), delimiter=",")
